...
public class InjectSurfaceView extends SurfaceView implements SurfaceHolder.Callback {
    ...
    private static final int DISTANCE_DIAMETER = 650;
    private static final int NUMBER_OF_TARGETS = 10;
    public static ArrayList<Coordinates> XYPair;
    private static double INDEX_OF_DIFFICULTY = 5;
    ...
    private Context con;
    private boolean isInitialized, isFinished, isTapped, isAccelerate, isGestureAcquired;
    private int order;
